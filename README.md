...
> **暂停适配说明**
>
> 本项目目前已暂停继续适配 Hermes / 飞书 Workbench 相关变更。现有代码仅作为历史版本保留，不建议继续作为新项目接入使用。
>
> 如果你需要飞书 / Lark 自动化、插件或 Agent 工作流，请转向其他仍在维护的方案使用。
...
`feishu-workbench-lite` 只适合 discovery / 轻量状态检查。本插件会注册这些轻量自包含工具：
